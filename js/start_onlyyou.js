        ...
        if(typeof(start_content['chase_benefit'])!='undefined'){
            ...
            if(array_oy_benefit[0]==''){
                array_oy_benefit[0]='终身抱抱服务';
            }
            if(array_oy_benefit[1]==''){
                array_oy_benefit[1]='终身美食服务';
            }
            if(array_oy_benefit[2]==''){
                array_oy_benefit[2]='终身游玩券服务';
            }
            if(array_oy_benefit[3]==''){
                array_oy_benefit[3]='终身精油SPA服务';
            }
        }else{
            array_oy_benefit=['终身抱抱服务','终身美食服务','终身游玩券服务','终身精油SPA服务'];
        }
